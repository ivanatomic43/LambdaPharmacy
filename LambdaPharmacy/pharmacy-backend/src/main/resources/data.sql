...
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (1, 'None', '3', 'AVAILABLE', 'Humani lekovi','111','NO_RECIPE','Strepsils','Pogodno za decu','RECKITT BENCKISER HEALTHCARE','Lozenga', '2,4-dihlorbenzilalkohol, amilmetakrezol',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status,  med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (2, 'None', '4', 'AVAILABLE','Humani lekovi','112','NO_RECIPE','Andol','Za sve vrste bolova u telu','Pliva Hrvatska','Tableta', 'acetilsalicilna kiselina',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status,  med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (3, 'None', '2','AVAILABLE','Humani lekovi','113','NO_RECIPE','Aspirin 500mg','Za jaku glavobolju','	BAYER BITTERFELD GMBH','Tableta','acetilsalicilna kiselina',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape, structure, version) VALUES (4, 'Alergies', '1','AVAILABLE','Humani lekovi','114','RECIPE','	Enalapril Remedica 10mg','Za kontrolu povišenog krvnog pritiska','REMEDICA LTD','Tableta', 'enalapril',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (5, 'Heart problems', '2','AVAILABLE','Humani lekovi','115','NO_RECIPE','Brufen 100mg','Za prehlade, kasalj i temepraturu','ABBVIE S.R.L.','Sirup', 'ibuprofen',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (6, 'None', '2','AVAILABLE','Homeopatski lekovi','116','NO_RECIPE','Influcid','Koristi se u terapiji infekcija slicnih gripu','DEUTSCHE HOMOOPATHIE-UNION','Tableta','Aconitum trit. D3 25 mg Gelsemium trit. D3 ',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape, structure, version) VALUES (7, 'None', '1','AVAILABLE','Homeopatski lekovi','117','NO_RECIPE','Polinol','Za terapiju alergijskih reakcija disajnih puteva','DEUTSCHE HOMOOPATHIE-UNION ','Tableta', 'luffa operculata trit. D4, galphimia glauca trit. D3, cardiospermum trit. D3',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status, med_type, medicine_code, mode, name, note, producer, shape, structure, version) VALUES (8, 'Alergies', '2','AVAILABLE','Humani lekovi','118','RECIPE','Kardioprotekt','Za smanjenje rizika smrtnosti kod osoba koje su preživele infarkt kao i za sprečavanje moždanog udara','AD JAKA 80 RADOVIŠ','Gastrorezistentna tableta', 'acetilsalicilna kiselina',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status,  med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (9, 'Not for children', '1','AVAILABLE','Humani lekovi','119','RECIPE','Xanax','Namenjen za lečenje anksioznosti, napetosti ili drugih somatskih (telesnih) ili psihijatrijskih simptoma povezanih sa anksioznošću','PFIZER ITALIA S.R.L.','Tableta', 'alprazolam',0);
INSERT INTO MEDICINE (id, contraindications, daily_dose, default_status,  med_type, medicine_code, mode, name, note, producer, shape,  structure, version) VALUES (10, 'None', '2','AVAILABLE','Humani lekovi','120','RECIPE','Rantudil forte 60mg','Koristi se u terapiji bola i zapaljenja kod reumatoidnog artritisa (hronični poliartritis)','MEDA MANUFACTURING GMBH','Kapsula', 'acemetacin',0);
